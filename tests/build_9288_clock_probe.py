#!/usr/bin/env python3
"""Build a read-only S1C33L05 clock/identity probe for BBK 9288."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output", type=Path, default=BUILD / "CLOCK_TEST.exe")
...
def main() -> None:
    ...
    elf = BUILD / "CLOCK_TEST.elf"
    map_path = BUILD / "CLOCK_TEST.map"
    run(
        [
            clang,
            "--target=s1c33-none-elf",
    ...
    app[12:28] = b"CLOCK_TEST".ljust(16, b"\0")
