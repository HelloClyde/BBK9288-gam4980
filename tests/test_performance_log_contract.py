...
def test_performance_log(frontend: str) -> None:
    ...
    required_writer_tokens = (
        '"rom_cache_index_version"',
        '"rom_cache_index_bytes"',
        '"rom_cache_index_lookups"',
        '"rom_cache_index_hits"',
        '"rom_cache_index_misses"',
        '"framebuffer_direct_version"',
        '"framebuffer_direct_rows"',
        '"framebuffer_direct_bytes"',
        '"framebuffer_direct_full_refreshes"',
        '"native_graphics_version"',
        '"native_graphics_host_tick_hz"',
        '"native_graphics_host_time_in_core"',
        '"native_graphics_timing_enabled"',
        '"native_graphics_lcd_bytes"',
        '"native_graphics_host_ticks"',
        '"native_graphics_attempts"',
        '"native_text_host_ticks"',
        '"native_text_attempts"',
        '"native_bank_dispatch_version"',
        '"native_module_full_rebuilds"',
        '"native_module_bank_refreshes"',
        '"native_module_bank_nochanges"',
        '"native_module_function_bank_fastpaths"',
        '"native_module_rebuild_module_visits"',
        ...
        '"static_native_compiled"',
        '"static_native_bound"',
        '"static_native_modules"',
        '"static_native_blocks"',
        '"static_native_guest_bytes"',
        '"static_native_code_bytes"',
        '"static_native_invalidations"',
        '"game_aot_linear_link_hits"',
        '"game_aot_runtime_lift_hits"',
        '"game_aot_trace_entries"',
        '"game_aot_trace_hits"',
        '"game_aot_trace_instruction_hits"',
    ...
    required_diagnostic_tokens = (
        ...
        '"native_atomic_contracts_version"',
        '"nat_sample_private_attempts"',
        '"nat_sample_private_accepted"',
        '"native_bank_batch_version"',
        '"native_d2f6_reject_descriptor"',
        '"native_d2f6_reject_budget"',
        '"wall_guest_rate_cycle_equivalent"',
